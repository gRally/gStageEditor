...
Shader "gRally/Procedural_Terrain_Shader v3"
{
	Properties
	{
		...
		[NoScaleOffset][Space(20)][Header(Textures Arrays)]_AlbedoMapsArray("Albedo Maps Array", 2DArray) = "white" {}
		[NoScaleOffset]_NormalMapsArray("Normal Maps Array", 2DArray) = "white" {}
		...
		[NoScaleOffset]_AlbedoMapsArrayFlatWorld("Albedo Maps Array FlatWorld", 2DArray) = "white" {}
		[NoScaleOffset]_NormalMapsArrayFlatWorld("Normal Maps Array FlatWorld", 2DArray) = "white" {}
	...
	SubShader
	{
		...
		UNITY_DECLARE_TEX2DARRAY_NOSAMPLER(_NormalMapsArray);
		uniform float2 _MidSlopeNearUV;
		SamplerState sampler_NormalMapsArray;
		...
		UNITY_DECLARE_TEX2DARRAY_NOSAMPLER(_NormalMapsArrayFlatWorld);
		uniform float4 _UVOffset5thMap;
		SamplerState sampler_NormalMapsArrayFlatWorld;
		...
		UNITY_DECLARE_TEX2DARRAY_NOSAMPLER(_AlbedoMapsArray);
		SamplerState sampler_AlbedoMapsArray;
		...
		UNITY_DECLARE_TEX2DARRAY_NOSAMPLER(_AlbedoMapsArrayFlatWorld);
		SamplerState sampler_AlbedoMapsArrayFlatWorld;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 FlatWorld_Normal567 = ( ( BlendNormals( BlendNormals( BlendNormals( UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _NormalMapsArrayFlatWorld, sampler_NormalMapsArrayFlatWorld, float3(UV5thMap541,4.0) ), FW_mask5545 ) , UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _NormalMapsArrayFlatWorld, sampler_NormalMapsArrayFlatWorld, float3(UV4thMap540,3.0) ), FW_mask4488 ) ) , UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _NormalMapsArrayFlatWorld, sampler_NormalMapsArrayFlatWorld, float3(UV3rdMap539,2.0) ), FW_mask3487 ) ) , BlendNormals( UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _NormalMapsArrayFlatWorld, sampler_NormalMapsArrayFlatWorld, float3(UV2ndMap538,1.0) ), FW_mask2486 ) , UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _NormalMapsArrayFlatWorld, sampler_NormalMapsArrayFlatWorld, float3(UV1stMap537,0.0) ), FW_mask1485 ) ) ) * ( 1.0 - cameraDistance83 ) ) + ( UnpackNormal( tex2D( _FlatNormal, uv_FlatNormal656 ) ) * cameraDistance83 ) );
			#ifdef _FLATWORLDNORMAL_ON
				float3 staticSwitch552 = FlatWorld_Normal567;
			#else
				float3 staticSwitch552 = BlendNormals( BlendNormals( BlendNormals( BlendNormals( UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _NormalMapsArray, sampler_NormalMapsArray, float3(MidSlopeNearUV_1312,2.0) ), ( ( 1.0 - temp_output_186_0 ) * temp_output_226_0 * SlopeBlend_2100 * _MediumSlopeNearNormalMultiplier ) ) , UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _NormalMapsArray, sampler_NormalMapsArray, float3(MidSlopeFarUV_1313,3.0) ), ( temp_output_186_0 * temp_output_226_0 * SlopeBlend_2100 * _MediumSlopeFarNormalMultiplier ) ) ) , BlendNormals( BlendNormals( UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _NormalMapsArray, sampler_NormalMapsArray, float3(LowSlopeNearUV_1307,0.0) ), ( ( 1.0 - temp_output_179_0 ) * temp_output_215_0 * SlopeBlend_199 * _LowSlopeNearNormalMultiplier ) ) , UnpackScaleNormal( tex2D( _SecondaryMapVP_Normal, uv_SecondaryMapVP_Normal ), ( temp_output_179_0 * temp_output_215_0 * SlopeBlend_199 * _SecondaryMapNormalMultiplier ) ) ) , UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _NormalMapsArray, sampler_NormalMapsArray, float3(LowSlopeFarUV_1308,1.0) ), ( temp_output_190_0 * SlopeBlend_199 * _LowSlopeFarNormalMultiplier ) ) ) ) , BlendNormals( UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _NormalMapsArray, sampler_NormalMapsArray, float3(HighSlopeNearUV_1310,4.0) ), ( ( 1.0 - temp_output_193_0 ) * temp_output_265_0 * _HighSlopeNearNormalMultiplier ) ) , UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _NormalMapsArray, sampler_NormalMapsArray, float3(HighSlopeFarUV_1311,5.0) ), ( temp_output_193_0 * temp_output_265_0 * _HighSlopeFarNormalMultiplier ) ) ) ) , UnpackScaleNormal( tex2D( _TerraintoPathTexNormal, uv_TerraintoPathTexNormal ), VertexColor_AChan423 ) );
			#endif
			...
			float4 FlatWorld_Albedo463 = ( ( ( ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArrayFlatWorld, sampler_AlbedoMapsArrayFlatWorld, float3(UV1stMap537,0.0) ) * ( 1.0 - cameraDistance83 ) ) + ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArrayFlatWorld, sampler_AlbedoMapsArrayFlatWorld, float3(( uv_TexCoord521 * float2( 0.1,0.1 ) ),0.0) ) * cameraDistance83 ) ) * FW_mask1485 ) + ( ( ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArrayFlatWorld, sampler_AlbedoMapsArrayFlatWorld, float3(UV2ndMap538,1.0) ) * ( 1.0 - cameraDistance83 ) ) + ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArrayFlatWorld, sampler_AlbedoMapsArrayFlatWorld, float3(( uv_TexCoord520 * float2( 0.1,0.1 ) ),1.0) ) * cameraDistance83 ) ) * FW_mask2486 ) + ( ( ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArrayFlatWorld, sampler_AlbedoMapsArrayFlatWorld, float3(UV3rdMap539,2.0) ) * ( 1.0 - cameraDistance83 ) ) + ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArrayFlatWorld, sampler_AlbedoMapsArrayFlatWorld, float3(( uv_TexCoord522 * float2( 0.1,0.1 ) ),2.0) ) * cameraDistance83 ) ) * FW_mask3487 ) + ( ( ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArrayFlatWorld, sampler_AlbedoMapsArrayFlatWorld, float3(UV4thMap540,3.0) ) * ( 1.0 - cameraDistance83 ) ) + ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArrayFlatWorld, sampler_AlbedoMapsArrayFlatWorld, float3(( uv_TexCoord523 * float2( 0.1,0.1 ) ),3.0) ) * cameraDistance83 ) ) * FW_mask4488 ) + ( FW_mask5545 * ( ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArrayFlatWorld, sampler_AlbedoMapsArrayFlatWorld, float3(UV5thMap541,4.0) ) * ( 1.0 - saturate( cameraDistance83 ) ) ) + ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArrayFlatWorld, sampler_AlbedoMapsArrayFlatWorld, float3(( uv_TexCoord524 * float2( 0.1,0.1 ) ),4.0) ) * cameraDistance83 ) ) ) );
			#ifdef _FLATWORLDALBEDO_ON
				float4 staticSwitch461 = FlatWorld_Albedo463;
			#else
				float4 staticSwitch461 = ( ( ( ( ( ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArray, sampler_AlbedoMapsArray, float3(HighSlopeNearUV_1310,4.0) ) * ( 1.0 - temp_output_115_0 ) ) + ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArray, sampler_AlbedoMapsArray, float3(HighSlopeFarUV_1311,5.0) ) * temp_output_115_0 ) ) * ( 1.0 - temp_output_454_0 ) ) + ( ( ( ( ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArray, sampler_AlbedoMapsArray, float3(MidSlopeNearUV_1312,2.0) ) * ( 1.0 - temp_output_114_0 ) ) + ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArray, sampler_AlbedoMapsArray, float3(MidSlopeFarUV_1313,3.0) ) * temp_output_114_0 ) ) * ( 1.0 - temp_output_450_0 ) ) + ( ( ( ( ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArray, sampler_AlbedoMapsArray, float3(LowSlopeNearUV_1307,0.0) ) * ( 1.0 - temp_output_170_0 ) ) + ( tex2DNode167 * temp_output_170_0 ) ) * ( 1.0 - temp_output_113_0 ) ) + ( ( ( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMapsArray, sampler_AlbedoMapsArray, float3(LowSlopeFarUV_1308,1.0) ) * ( 1.0 - temp_output_170_0 ) ) + ( tex2DNode167 * temp_output_170_0 ) ) * temp_output_113_0 ) ) * temp_output_450_0 ) ) * temp_output_454_0 ) ) * ( 1.0 - VertexColor_AChan423 ) ) + ( tex2D( _TerraintoPathTexAlbedo, uv_TerraintoPathTexAlbedo ) * VertexColor_AChan423 ) );
			#endif
			float4 AlbedoChan414 = staticSwitch461;
			o.Albedo = AlbedoChan414.rgb;
			float temp_output_340_0 = 0.0;
			float3 temp_cast_3 = (temp_output_340_0).xxx;
...
/*ASEBEGIN
Version=18707
1962;9;1845;1019;742.2781;469.2687;1.285;True;True
Node;AmplifyShaderEditor.SamplerNode;55;405.9958,-641.5554;Inherit;True;Property;_SlopeNoiseMasks;Slope Noise Masks;5;0;Create;True;0;0;False;0;False;-1;None;17d41c6ac262c9a4b9612b5027c39cf8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;52;517.3821,-1120.689;Inherit;False;Property;_LowtoMedSlope;Low to Med Slope;3;0;Create;True;0;0;False;0;False;0;2.96;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;493.704,-1236.619;Inherit;False;Property;_OverallSlopeContrast;Overall Slope Contrast;2;0;Create;True;0;0;False;1;Header(Slope Blender Controls);False;0;2.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;361;972.1348,-493.4162;Half;False;Property;_ContrastNoiseMapRChan;Contrast Noise Map R Chan;6;0;Create;True;0;0;False;0;False;0;1.47;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;344;460.1158,-767.3024;Half;False;Property;_ContrastVP;Contrast VP;16;0;Create;True;0;0;False;0;False;0;2.12;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;668;-5878.786,-6257.008;Inherit;False;Property;_VsizetileU;Vsize / tileU;41;1;[HideInInspector];Create;True;0;0;False;0;False;0;3590.891;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;667;-5874.161,-6588.273;Inherit;False;Property;_UsizetileV;Usize / tileV;43;1;[HideInInspector];Create;True;0;0;False;0;False;0;1837.593;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;669;-5492.996,-6263.348;Inherit;False;Property;_TileVVsize;TileV / Vsize;44;1;[HideInInspector];Create;True;0;0;False;0;False;0;0.0005569648;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;65;1152.43,-1087.493;Inherit;False;Property;_MedtoHighSlope;Med to High Slope;4;0;Create;True;0;0;False;0;False;0;2.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;666;-5512.652,-6597.783;Inherit;False;Property;_TileUUsize;TileU / Usize;42;1;[HideInInspector];Create;True;0;0;False;0;False;0;0.0002720951;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;1200.71,-1671.406;Inherit;False;Property;_CameraDistance;Camera Distance;0;0;Create;True;0;0;False;1;Header(Camera Distance Blender (Near to Far));False;0;300;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;171;755.0214,-41.0242;Inherit;False;Property;_VertexPaintBlenderMultiplier;VertexPaint Blender Multiplier;13;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;295;576.6749,-2656.671;Inherit;False;Property;_LowSlopeNearUV;LowSlope Near UV;17;0;Create;True;0;0;False;1;Header(UV Controls);False;1,1;0.02,0.02;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;3;1207.545,-1584.791;Inherit;False;Property;_CamDistanceFalloff;Cam Distance Falloff;1;0;Create;True;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;297;575.9579,-2513.983;Inherit;False;Property;_LowSlopeFarUV;LowSlope Far UV;18;0;Create;True;0;0;False;0;False;1,1;0.005,0.005;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;437;1088.18,-385.5399;Half;False;Property;_ContrastNoiseMapGChan;Contrast Noise Map G Chan;7;0;Create;True;0;0;False;0;False;0;1.84;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;501;-4664.896,-6465.77;Inherit;True;Property;_FlatWorldMasks;Flat World Masks;32;1;[NoScaleOffset];Create;False;0;0;False;1;Header(The texture mask group on VS must named maskFlatWorld);False;-1;None;406d58c88763b1a49814962dd08e3a46;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;572;-4948.744,-6024.934;Inherit;False;Property;_UVOffset5thMap;UV & Offset 5th Map;39;0;Create;True;0;0;False;0;False;0,0,0,0;0.07,0.07,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;300;1446.456,-2523.146;Inherit;False;Property;_MidSlopeFarUV;MidSlope Far UV;20;0;Create;True;0;0;False;0;False;1,1;0.002,0.002;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.GetLocalVarNode;205;-6066.101,-1454.946;Inherit;False;204;VP_Multy;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;608;-4956.859,-5518.89;Inherit;False;Property;_UVOffset4thMap;UV & Offset 4th Map;38;0;Create;True;0;0;False;0;False;0,0,0,0;0.05,0.05,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;299;1444.052,-2665.085;Inherit;False;Property;_MidSlopeNearUV;MidSlope Near UV;19;0;Create;True;0;0;False;0;False;1,1;0.01,0.01;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector4Node;616;-4930.538,-4964.884;Inherit;False;Property;_UVOffset3rdMap;UV & Offset 3rd Map;37;0;Create;True;0;0;False;0;False;0,0,0,0;0.05,0.05,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;638;-4898.005,-3873.085;Inherit;False;Property;_UVOffset1stMap;UV & Offset 1st Map;35;0;Create;True;0;0;False;0;False;0,0,0,0;0.05,0.05,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;628;-4913.749,-4430.063;Inherit;False;Property;_UVOffset2ndMap;UV & Offset 2nd Map;36;0;Create;True;0;0;False;0;False;0,0,0,0;0.05,0.05,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;459;1157.991,-289.9096;Inherit;False;Property;_ContrastNoiseMapBChan;Contrast Noise Map B Chan;8;0;Create;True;0;0;False;0;False;0;1.83;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;306;594.2219,-2103.849;Inherit;False;Property;_HighSlopeFarUV;HighSlope Far UV;22;0;Create;True;0;0;False;0;False;1,1;0.005,0.005;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;305;580.9476,-2236.007;Inherit;False;Property;_HighSlopeNearUV;HighSlope Near UV;21;0;Create;True;0;0;False;0;False;1,1;0.01,0.01;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;333;-5989.312,-2271.534;Inherit;True;Property;_AlbedoMapsArray;Albedo Maps Array;9;1;[NoScaleOffset];Create;True;0;0;False;2;Space(20);Header(Textures Arrays);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;167;-5969.021,-1784.694;Inherit;True;Property;_SecondaryMapVP_Albedo;Secondary Map VP Blended (Albedo);14;0;Create;False;0;0;False;0;False;-1;None;d68366b5fdf0f9d43af6c813ac51b5b5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;268;-5972.286,-2036.096;Inherit;True;Property;_AlbedoNoSlopeNear;Albedo NoSlope Near;9;1;[NoScaleOffset];Create;True;0;0;False;2;Space(20);Header(Textures Arrays);False;-1;None;None;True;0;False;white;Auto;False;Instance;333;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;1;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;270;-4498.29,-1986.155;Inherit;True;Property;_TextureArray3;Texture Array 3;9;1;[NoScaleOffset];Create;True;0;0;False;2;Space(20);Header(Textures Arrays);False;-1;None;None;True;0;False;white;Auto;False;Instance;333;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;3;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;271;-4478.15,-2258.155;Inherit;True;Property;_TextureArray4;Texture Array 4;9;1;[NoScaleOffset];Create;True;0;0;False;2;Space(20);Header(Textures Arrays);False;-1;None;None;True;0;False;white;Auto;False;Instance;333;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;2;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;419;-5871.181,30.46696;Inherit;False;Property;_SecondaryMapNormalMultiplier;Secondary Map Normal Multiplier;24;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;555;-3775.579,1615.722;Inherit;True;Property;_TextureArray15;Texture Array 15;34;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Instance;544;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;3;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;338;-5893.268,-68.46199;Inherit;False;Property;_LowSlopeNearNormalMultiplier;Low Slope Near Normal Multiplier;23;0;Create;True;0;0;False;1;Header(Normal Maps Multipliers);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;556;-3786.058,1339.346;Inherit;True;Property;_TextureArray16;Texture Array 16;34;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Instance;544;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;4;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;634;-3941.844,-3661.79;Inherit;True;Property;_TextureArray21;Texture Array 21;33;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;508;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;339;-5775.225,560.3792;Inherit;False;Property;_LowSlopeFarNormalMultiplier;Low Slope Far Normal Multiplier;25;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;599;-3957.711,-5288.195;Inherit;True;Property;_TextureArray18;Texture Array 18;33;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;508;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;3;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;509;-3958.333,-4461.121;Inherit;True;Property;_TextureArray5;Texture Array 5;33;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;508;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;1;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;273;-3239.96,-2082.945;Inherit;True;Property;_TextureArray6;Texture Array 6;9;1;[NoScaleOffset];Create;True;0;0;False;2;Space(20);Header(Textures Arrays);False;-1;None;None;True;0;False;white;Auto;False;Instance;333;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;5;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;609;-3942.706,-4752.225;Inherit;True;Property;_TextureArray19;Texture Array 19;33;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;508;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;2;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;405;-2907.037,-2326.879;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;337;-3919.548,-296.8571;Inherit;False;Property;_MediumSlopeNearNormalMultiplier;Medium Slope Near Normal Multiplier;26;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;272;-3244.305,-2365.95;Inherit;True;Property;_TextureArray7;Texture Array 7;9;1;[NoScaleOffset];Create;True;0;0;False;2;Space(20);Header(Textures Arrays);False;-1;None;None;True;0;False;white;Auto;False;Instance;333;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;4;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;508;-3932.873,-4990.394;Inherit;True;Property;_AlbedoMapsArrayFlatWorld;Albedo Maps Array FlatWorld;33;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;2;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;511;-3945.783,-3918.314;Inherit;True;Property;_TextureArray8;Texture Array 8;33;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;508;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;516;-3970.218,-5540.699;Inherit;True;Property;_TextureArray11;Texture Array 11;33;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;508;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;3;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;544;-3737.227,2385.396;Inherit;True;Property;_NormalMapsArrayFlatWorld;Normal Maps Array FlatWorld;34;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;336;-3991.754,175.5885;Inherit;False;Property;_MediumSlopeFarNormalMultiplier;Medium Slope Far Normal Multiplier;27;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;554;-3773.676,1891.127;Inherit;True;Property;_TextureArray14;Texture Array 14;34;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Instance;544;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;2;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;553;-3770.431,2145.093;Inherit;True;Property;_TextureArray13;Texture Array 13;34;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Instance;544;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;1;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;624;-3929.459,-4196.33;Inherit;True;Property;_TextureArray20;Texture Array 20;33;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;508;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;1;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;518;-3969.943,-6033.36;Inherit;True;Property;_TextureArray12;Texture Array 12;33;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;508;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;4;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;596;-3966.496,-5825.462;Inherit;True;Property;_TextureArray17;Texture Array 17;33;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;508;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;4;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;332;-5338.502,-258.185;Inherit;True;Property;_NormalMapsArray;Normal Maps Array;10;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;181;-5348.01,26.48502;Inherit;True;Property;_SecondaryMapVP_Normal;Secondary Map VP Blended (Normal);15;0;Create;False;0;0;False;0;False;-1;None;6e75dcf2f88b61f4f92a017c49f11b3e;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;334;-3749.654,572.9985;Inherit;False;Property;_HighSlopeNearNormalMultiplier;High Slope Near Normal Multiplier;28;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;335;-3786.462,888.589;Inherit;False;Property;_HighSlopeFarNormalMultiplier;High Slope Far Normal Multiplier;29;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;614;-3145.824,-4912.296;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;327;-5300.01,298.485;Inherit;True;Property;_TextureArray9;Texture Array 9;10;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Instance;332;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;1;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;615;-2982.743,-4823.655;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;656;-2680.268,2114.208;Inherit;True;Property;_FlatNormal;FlatNormal;40;2;[HideInInspector];[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;328;-3413.594,-313.2501;Inherit;True;Property;_TextureArray1;Texture Array 1;10;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Instance;332;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;2;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;329;-3413.594,-73.24999;Inherit;True;Property;_TextureArray10;Texture Array 10;10;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Instance;332;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;3;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;495;-2495.994,-4985.939;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;330;-3229.37,414.845;Inherit;True;Property;_TextureArray0;Texture Array 0;10;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Instance;332;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;4;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;331;-3213.37,670.8451;Inherit;True;Property;_TextureArray2;Texture Array 2;10;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Instance;332;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;5;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;470;-1722.636,-5300.576;Inherit;True;5;5;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;429;-2500.108,-1339.203;Inherit;True;Property;_TerraintoPathTexAlbedo;Terrain to Path Tex Albedo;11;0;Create;True;0;0;False;0;False;-1;None;ca5a7e3f6c89fb44ab33c482124a799e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;431;-1959.072,547.8278;Inherit;True;Property;_TerraintoPathTexNormal;Terrain to Path Tex Normal;12;0;Create;True;0;0;False;0;False;-1;None;02ea2d9225227c243acd283bdddf6575;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;552;-1319.598,276.1972;Inherit;False;Property;_FlatWorldNormal;Flat World Normal;31;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;461;-1373.526,-1699.728;Inherit;False;Property;_FlatWorldAlbedo;Flat World Albedo;30;0;Create;True;0;0;False;2;Space(20);Header(Flat World settings);False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;340;-41.86125,235.8529;Inherit;False;Constant;_Float3;Float 3;24;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;369;1173.656,452.2056;Inherit;False;Constant;_Color1;Color 1;25;0;Create;True;0;0;False;0;False;0,0.2876301,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;550;-1309.164,-1297.438;Inherit;False;Constant;_Color7;Color 7;45;0;Create;True;0;0;False;0;False;0.4622642,0.4622642,0.4622642,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;368;1173.656,234.8561;Inherit;False;Constant;_Color0;Color 0;25;0;Create;True;0;0;False;0;False;1,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;370;1147.111,650.6559;Inherit;False;Constant;_Float4;Float 4;26;0;Create;True;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;269.08,36.79;Float;False;True;-1;3;ASEMaterialInspector;0;0;StandardSpecular;gRally/Procedural_Terrain_Shader v3;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;555;1;561;0
WireConnection;555;5;562;0
...
WireConnection;508;1;539;0
WireConnection;511;1;537;0
WireConnection;516;1;540;0
WireConnection;544;1;546;0
WireConnection;544;5;548;0
WireConnection;185;0;179;0
WireConnection;185;1;215;0
WireConnection;185;2;222;0
WireConnection;185;3;419;0
WireConnection;554;1;559;0
WireConnection;554;5;560;0
WireConnection;553;1;557;0
WireConnection;553;5;558;0
...
WireConnection;331;1;325;0
WireConnection;331;5;230;0
...
ASEEND*/
//CHKSM=F38E6FE96ED7854B48618F68B7817B2ADD7D3CC7