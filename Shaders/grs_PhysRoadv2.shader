...
Shader "gRally/Phys Road v2"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float smoothstepResult24 = smoothstep( ( lerpResult150 * ( 1.0 - ( ( 1.0 - tex2DNode118.r ) * ( temp_output_110_0 * temp_output_111_0 ) ) ) * ( 1.0 - ( ( temp_output_110_0 * temp_output_112_0 ) * ( 1.0 - tex2DNode118.g ) ) ) * ( 1.0 - ( ( temp_output_114_0 * temp_output_111_0 ) * ( 1.0 - tex2DNode118.b ) ) ) * ( 1.0 - ( ( temp_output_114_0 * temp_output_112_0 ) * ( 1.0 - tex2DNode118.a ) ) ) ) , 1.0 , _GR_WetSurf);
...
/*ASEBEGIN
Version=14401
1949;91;1762;925;5965.482;2170.162;1;True;True
Node;AmplifyShaderEditor.WorldPosInputsNode;101;-5974.614,378.795;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;93;-5956.034,789.8777;Float;False;Property;_PuddlesSize;Puddles Size;10;0;Create;True;0;1.66;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;153;-5283.106,-1899.414;Float;False;Property;_TilingMainTextures;Tiling Main Textures;3;0;Create;True;1,1;1,0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;163;-5286.705,-1755.028;Float;False;Property;_OffsetMainTextures;Offset Main Textures;4;0;Create;True;0,0;1,0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.OneMinusNode;162;-3752.569,1158.745;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;160;-3694.944,589.4099;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;159;-3752.568,349.6893;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;161;-3678.808,854.4844;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;155;-3143.473,458.574;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;158;-3102.753,1301.15;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;156;-3089.978,790.1494;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;157;-3110.053,1060.25;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;97;-2209.954,347.9238;Float;True;5;5;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;1;FLOAT;0
...
WireConnection;162;0;118;4
WireConnection;119;0;110;0
WireConnection;119;1;111;0
WireConnection;160;0;118;2
WireConnection;159;0;118;1
WireConnection;116;0;110;0
WireConnection;116;1;112;0
WireConnection;161;0;118;3
...
WireConnection;120;1;162;0
WireConnection;121;0;116;0
WireConnection;121;1;160;0
...
WireConnection;97;1;155;0
WireConnection;97;2;156;0
WireConnection;97;3;157;0
WireConnection;97;4;158;0
...
ASEEND*/
//CHKSM=844941C0E30818D47320B8366C0F76964DCB905F