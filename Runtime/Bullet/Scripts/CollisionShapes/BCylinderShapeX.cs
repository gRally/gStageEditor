...
{
    [AddComponentMenu("Physics Bullet/Shapes/Cylinder X")]
    public class BCylinderShapeX : BCollisionShape
    {
        [SerializeField]
        ...
        */
        ...
        public override void OnDrawGizmosSelected()
        {
            ...
            BUtility.DebugDrawCylinder(position, rotation, scale, halfExtent.x, halfExtent.y, 0, Color.yellow);
        }
