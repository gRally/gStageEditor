    ...
    public class BPhysicsWorld : MonoBehaviour, IDisposable
    {
        ...
        public static BPhysicsWorld Get()
        {
            if (singleton == null && !_isDisposed)
            {
                ...
                {
                    // gRally Debug.LogError("Need to add a dynamics world to the scene");
                }
                else {
        ...
        */
        ...
        // NU BPhysicsWorldLateHelper lateUpdateHelper;
        ...
        // NU ulong sequentialImpulseConstraintSolverRandomSeed = 12345;
        ...
        {
            // NU if (lateUpdateHelper != null) lateUpdateHelper.RegisterCollisionCallbackListener(toBeAdded);
        }

        public void DeregisterCollisionCallbackListener(BCollisionObject.BICollisionCallbackEventHandler toBeRemoved)
        {
            // NU if (lateUpdateHelper != null) lateUpdateHelper.DeregisterCollisionCallbackListener(toBeRemoved);
        }
