...
namespace BulletUnity {
    public static class BSExtensionMethods2 {
        ...
        public static UnityEngine.Vector3 ToUnity(this BulletSharp.Math.Vector3 v) {
            // gRally return new UnityEngine.Vector3(v.X, v.Y, v.Z);
        ...
        public static UnityEngine.Matrix4x4 ToUnity(this BulletSharp.Math.Matrix bm) {
            ...
            um[3, 0] = bm[0, 3];
            um[3, 1] = bm[1, 3];
            um[3, 2] = bm[3, 3]; //bm[2, 3];
            um[3, 3] = bm[2, 3]; //bm[3, 3];
            return um;
        }
        ...
        public static Vector3 ExtractTranslationFromMatrix(ref Matrix4x4 matrix) {
            ...
            return BulletSharp.Native.UtoB(translate); // gRally
        }
        ...
        public static Quaternion ExtractRotationFromMatrix(ref Matrix4x4 matrix) {
            ...
            return BulletSharp.Native.UtoB(Quaternion.LookRotation(forward, upwards));  // gRally
        }
        ...
        public static Vector3 ExtractScaleFromMatrix(ref Matrix4x4 matrix) {
            ...
            return BulletSharp.Native.UtoB(scale); // gRally
        }
