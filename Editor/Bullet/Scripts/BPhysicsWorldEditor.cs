...
public class BDynamicsWorldEditor : Editor
{
    ...
    */
    ...
    // NU GUIContent DebugRunMode = new GUIContent("Debug Run");
    public override void OnInspectorGUI()
    {
        ...
        /// gRally pw.gravity = EditorGUILayout.Vector3Field("Gravity", pw.gravity);
        /// gRally EditorGUILayout.Separator();
        ...
        if (GUI.changed)
        {
            ...
            /// gRally EditorSceneManager.MarkSceneDirty(EditorSceneManager.GetActiveScene());
