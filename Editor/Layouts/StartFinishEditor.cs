...
public class StartFinishEditor : Editor
{
    ...
    private void showPoints()
    {
        ...
        Handles.Button(pointC, handleRotation, size * handleSize * 3.0f, size * pickSize, Handles.DotHandleCap);

        size = HandleUtility.GetHandleSize(point0);
        Handles.color = Color.yellow;
        Handles.Button(point0, handleRotation, size * handleSize, size * pickSize, Handles.DotHandleCap);

        Handles.color = Color.red;
        size = HandleUtility.GetHandleSize(point1);
        Handles.Button(point1, handleRotation, size * handleSize, size * pickSize, Handles.DotHandleCap);

        Handles.color = Color.red;
        size = HandleUtility.GetHandleSize(point2);
        Handles.Button(point2, handleRotation, size * handleSize * 2.0f, size * pickSize * 2.0f, Handles.DotHandleCap);

        Handles.color = new Color(0.835f, 0.671f, 0.482f);
        size = HandleUtility.GetHandleSize(point3);
        Handles.Button(point3, handleRotation, size * handleSize, size * pickSize, Handles.DotHandleCap);


        Handles.color = Color.blue;
        size = HandleUtility.GetHandleSize(point4);
        Handles.Button(point4, handleRotation, size * handleSize, size * pickSize, Handles.DotHandleCap);

        Handles.color = Color.blue;
        size = HandleUtility.GetHandleSize(point5);
        Handles.Button(point5, handleRotation, size * handleSize, size * pickSize, Handles.DotHandleCap);

        Handles.color = Color.blue;
        size = HandleUtility.GetHandleSize(point6);
        Handles.Button(point6, handleRotation, size * handleSize, size * pickSize, Handles.DotHandleCap);


        Handles.color = Color.yellow;
        size = HandleUtility.GetHandleSize(point7);
        Handles.Button(point7, handleRotation, size * handleSize, size * pickSize, Handles.DotHandleCap);

        Handles.color = Color.red;
        size = HandleUtility.GetHandleSize(point8);
        Handles.Button(point8, handleRotation, size * handleSize * 2.0f, size * pickSize * 2.0f, Handles.DotHandleCap);

        Handles.color = Color.red;
        size = HandleUtility.GetHandleSize(point9);
        Handles.Button(point9, handleRotation, size * handleSize, size * pickSize, Handles.DotHandleCap);

        Handles.color = new Color(0.835f, 0.671f, 0.482f);
        size = HandleUtility.GetHandleSize(point10);
        Handles.Button(point10, handleRotation, size * handleSize, size * pickSize, Handles.DotHandleCap);
    }
